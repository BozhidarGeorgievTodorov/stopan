...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--rf", type=int, default=None, help="Copias remotas HRW que se consultarán durante restore. Usa 0 para restore local.")
    parser.add_argument("--membership-seed", default=None, help="Seed de membership para recuperación remota bajo demanda.")
